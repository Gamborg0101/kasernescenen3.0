/*
  ...
  - You are about to drop the column `roomNum` on the `Room` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Room_roomNum_key";

-- AlterTable
ALTER TABLE "Room" DROP COLUMN "roomNum",
